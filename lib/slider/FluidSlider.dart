...
class _FluidSliderState extends State<FluidSlider> with SingleTickerProviderStateMixin {
  ...
  TextStyle _currentValTextStyle(BuildContext context) {
    final TextStyle defaultStyle = TextStyle(color: Colors.red);
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final RelativeRect beginRect =
            RelativeRect.fromLTRB(thumbPositionLeft!, 0.00, thumbPositionRight!, 0.0);

        //Popped up position of slider thumb.
        final poppedPosition = thumbDiameter! + 5;
        final RelativeRect endRect = RelativeRect.fromLTRB(
            thumbPositionLeft, poppedPosition * -1, thumbPositionRight, poppedPosition);
        ...
        return Container(
          ...
          child: Stack(
            ...
            children: <Widget>[
              _MinMaxLabels(
                textStyle: widget.labelsTextStyle ?? TextStyle(color: Colors.red),
                alignment: Alignment.centerLeft,
                child: widget.start ?? Container(),
                value: widget.min,
